        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <div class="card bg-base-100/10 backdrop-blur">
            <div class="card-body items-center text-center">
              ...
              <h3 class="card-title text-primary-content text-base">インタラクティブな可視化</h3>
              <p class="text-primary-content/80 text-sm">スキャッタープロットで意見の分布を確認</p>
            </div>
          </div>
          ...
          <div class="card bg-base-100/10 backdrop-blur">
            <div class="card-body items-center text-center">
              <div class="w-12 h-12 rounded-xl bg-base-100/20 flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary-content" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              ...
              <h3 class="card-title text-primary-content text-base">クラスタ別の閲覧</h3>
              <p class="text-primary-content/80 text-sm">階層的なクラスタ構造をドリルダウン</p>
            </div>
          </div>
          ...
          <div class="card bg-base-100/10 backdrop-blur">
            <div class="card-body items-center text-center">
              ...
              <h3 class="card-title text-primary-content text-base">簡単シェア</h3>
              <p class="text-primary-content/80 text-sm">URLを共有して第三者と結果を共有</p>
            </div>
          </div>
        </div>
      </main>
